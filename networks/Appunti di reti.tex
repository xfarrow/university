...
Si noti come quando il mittente è in attesa di una risposta dal destinatario non può ricevere una chiamata dal protocollo superiore \texttt{rdt\_send} e conseguentemente non può inviare un nuovo pacchetto. Protocolli di questo genere vengono chiamati protocolli stop-and-wait.
